...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_29282 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_29282(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_29286 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_29286(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_29292 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_29292(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_29297 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_29297(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_29306 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_29306(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_29312 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_29312(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__29259,callback){
var map__29261 = p__29259;
var map__29261__$1 = cljs.core.__destructure_map(map__29261);
var input = map__29261__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29261__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29261__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
