...
if((batch > (function (){var G__1026689 = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(pos);
return (slovarish.frontend.data.num_batches.cljs$core$IFn$_invoke$arity$1 ? slovarish.frontend.data.num_batches.cljs$core$IFn$_invoke$arity$1(G__1026689) : slovarish.frontend.data.num_batches.call(null,G__1026689));
})())){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(pos,"nouns")){
cljs.core.reset_BANG_(slovarish.frontend.data.top_2k_words,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__1026690){
var vec__1026691 = p__1026690;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1026691,(0),null);
var entries = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1026691,(1),null);
return cljs.core.some((function (p1__1026681_SHARP_){
return (new cljs.core.Keyword(null,"rank","rank",-1706728502).cljs$core$IFn$_invoke$arity$1(p1__1026681_SHARP_) <= (2000));
}),entries);
}),cljs.core.deref(slovarish.frontend.data.all_nouns)));

return cljs.core.reset_BANG_(slovarish.frontend.data.nouns_for_adj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.vec((function (){var iter__4652__auto__ = (function slovarish$frontend$data$load_edn_$_iter__1026694(s__1026695){
return (new cljs.core.LazySeq(null,(function (){
var s__1026695__$1 = s__1026695;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__1026695__$1);
if(temp__5753__auto__){
var s__1026695__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__1026695__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__1026695__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__1026697 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__1026696 = (0);
while(true){
if((i__1026696 < size__4651__auto__)){
var gender = cljs.core._nth(c__4650__auto__,i__1026696);
cljs.core.chunk_append(b__1026697,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (i__1026696,gender,c__4650__auto__,size__4651__auto__,b__1026697,s__1026695__$2,temp__5753__auto__){
return (function (p1__1026684_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__1026684_SHARP_,clojure.string.lower_case(p1__1026684_SHARP_));
});})(i__1026696,gender,c__4650__auto__,size__4651__auto__,b__1026697,s__1026695__$2,temp__5753__auto__))
,cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (i__1026696,gender,c__4650__auto__,size__4651__auto__,b__1026697,s__1026695__$2,temp__5753__auto__){
return (function (p1__1026683_SHARP_){
return new cljs.core.Keyword(null,"stressed","stressed",-936375069).cljs$core$IFn$_invoke$arity$1(cljs.core.first(cljs.core.val(p1__1026683_SHARP_)));
});})(i__1026696,gender,c__4650__auto__,size__4651__auto__,b__1026697,s__1026695__$2,temp__5753__auto__))
,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (i__1026696,gender,c__4650__auto__,size__4651__auto__,b__1026697,s__1026695__$2,temp__5753__auto__){
return (function (p1__1026682_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"gender","gender",-733930727).cljs$core$IFn$_invoke$arity$1(cljs.core.first(cljs.core.val(p1__1026682_SHARP_))),gender);
});})(i__1026696,gender,c__4650__auto__,size__4651__auto__,b__1026697,s__1026695__$2,temp__5753__auto__))
,cljs.core.deref(slovarish.frontend.data.top_2k_words)))));

var G__1026703 = (i__1026696 + (1));
i__1026696 = G__1026703;
continue;
} else {
return true;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__1026697),slovarish$frontend$data$load_edn_$_iter__1026694(cljs.core.chunk_rest(s__1026695__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__1026697),null);
}
} else {
var gender = cljs.core.first(s__1026695__$2);
return cljs.core.cons(cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (gender,s__1026695__$2,temp__5753__auto__){
return (function (p1__1026684_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__1026684_SHARP_,clojure.string.lower_case(p1__1026684_SHARP_));
});})(gender,s__1026695__$2,temp__5753__auto__))
,cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (gender,s__1026695__$2,temp__5753__auto__){
return (function (p1__1026683_SHARP_){
return new cljs.core.Keyword(null,"stressed","stressed",-936375069).cljs$core$IFn$_invoke$arity$1(cljs.core.first(cljs.core.val(p1__1026683_SHARP_)));
});})(gender,s__1026695__$2,temp__5753__auto__))
,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (gender,s__1026695__$2,temp__5753__auto__){
return (function (p1__1026682_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"gender","gender",-733930727).cljs$core$IFn$_invoke$arity$1(cljs.core.first(cljs.core.val(p1__1026682_SHARP_))),gender);
});})(gender,s__1026695__$2,temp__5753__auto__))
,cljs.core.deref(slovarish.frontend.data.top_2k_words)))),slovarish$frontend$data$load_edn_$_iter__1026694(cljs.core.rest(s__1026695__$2)));
}
} else {
return null;
}
...
})()),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__1026686_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__1026686_SHARP_,clojure.string.lower_case(p1__1026686_SHARP_));
}),cljs.core.remove.cljs$core$IFn$_invoke$arity$2(clojure.string.blank_QMARK_,cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__1026685_SHARP_){
return new cljs.core.Keyword(null,"plural","plural",-881591021).cljs$core$IFn$_invoke$arity$1(cljs.core.first(cljs.core.val(p1__1026685_SHARP_)));
}),cljs.core.deref(slovarish.frontend.data.top_2k_words))))));
} else {
return null;
}
...
return fetch(["edn/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pos),batch_no,".edn"].join('')).then((function (p1__1026687_SHARP_){
return p1__1026687_SHARP_.text();
})).then((function (p1__1026688_SHARP_){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3((function (){var G__1026698 = pos;
switch (G__1026698) {
case "nouns":
...
})(),cljs.core.merge,cljs.reader.read_string.cljs$core$IFn$_invoke$arity$1(p1__1026688_SHARP_));

cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(slovarish.frontend.data.batches_loaded,cljs.core.inc);

var G__1026699 = pos;
var G__1026700 = (batch + (1));
return (slovarish.frontend.data.load_edn.cljs$core$IFn$_invoke$arity$2 ? slovarish.frontend.data.load_edn.cljs$core$IFn$_invoke$arity$2(G__1026699,G__1026700) : slovarish.frontend.data.load_edn.call(null,G__1026699,G__1026700));
}));
}
});
