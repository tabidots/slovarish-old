...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__36210 = c;
var G__36210__$1 = (((G__36210 == null))?null:G__36210.prototype);
if((G__36210__$1 == null)){
return null;
} else {
return G__36210__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__36221 = c;
var G__36221__$1 = (((G__36221 == null))?null:G__36221.prototype);
if((G__36221__$1 == null)){
return null;
} else {
return G__36221__$1.render;
}
})() == null)))));
});
...
while (G__36470__i < G__36470__a.length) {G__36470__a[G__36470__i] = arguments[G__36470__i + 0]; ++G__36470__i;}
  args = new cljs.core.IndexedSeq(G__36470__a,0,null);
} 
...
var or__4253__auto__ = (function (){var G__36246 = c;
var G__36246__$1 = (((G__36246 == null))?null:G__36246.constructor);
if((G__36246__$1 == null)){
return null;
} else {
return G__36246__$1.displayName;
}
})();
...
var G__36252 = c;
var G__36252__$1 = (((G__36252 == null))?null:G__36252.constructor);
if((G__36252__$1 == null)){
return null;
} else {
return G__36252__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__36263 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__36264 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__36264);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__36263);
}});
...
var c = this;
var G__36285_36513 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__36285_36513 == null)){
} else {
reagent.ratom.dispose_BANG_(G__36285_36513);
}
...
var renders_36521 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_36522 = cljs.core.first(cljs.core.vals(renders_36521));
...
if((cljs.core.count(renders_36521) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_36521))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_36522)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_36522], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__36398 = o;
reagent.impl.component.goog$module$goog$object.set(G__36398,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__36426 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__36427 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__36427);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__36426);
}});
...
var vec__36430 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36430,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36430,(1),null);
...
var G__36435 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__36435 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__36435);
}
});
}),[]);
