...
return ((((cljs.core.not(cljs.core.re_find(/ь[ёе]$/,text))) && (clojure.string.ends_with_QMARK_(nom_plur,"\u044C\u044F")))) || (((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(text,"\u043A\u043E\u043B\u0435\u043D\u043E")) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(nom_plur,"\u043A\u043E\u043B\u0435\u043D\u0438")))) || ((((!(clojure.string.ends_with_QMARK_(text,"\u044C\u0451")))) && (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.count(cljs.core.re_seq(/ё/,gen_sing)),cljs.core.count(cljs.core.re_seq(/ё/,nom_plur)))))))));
}
}
}
}
...
return cljs.core.keys(slovarish.frontend.utils.re_pos(/[аеёиоуяюыэ]/,p1__34516_SHARP_));
