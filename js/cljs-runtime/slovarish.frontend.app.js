...
return slovarish.frontend.navigation.go_to_word.cljs$core$IFn$_invoke$arity$variadic(cljs.core.deref(slovarish.frontend.state.input),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"target-pos","target-pos",1907947494),which_pos], 0));
})], null),(function (){var G__1026535 = cljs.core.deref(slovarish.frontend.state.display_language);
var G__1026535__$1 = (((G__1026535 instanceof cljs.core.Keyword))?G__1026535.fqn:null);
switch (G__1026535__$1) {
case "english":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__1026535__$1)].join('')));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__1026536__$1)].join('')));

}
})(),new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__1026537 = cljs.core.deref(slovarish.frontend.state.pos);
var G__1026537__$1 = (((G__1026537 instanceof cljs.core.Keyword))?G__1026537.fqn:null);
switch (G__1026537__$1) {
case "noun":
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cljs.core.truth_(new cljs.core.Keyword(null,"verified?","verified?",863527758).cljs$core$IFn$_invoke$arity$1(slovarish.frontend.state.result()))?null:"light"),(function (){var or__4253__auto__ = (function (){var G__1026538 = slovarish.frontend.state.result();
var G__1026538__$1 = (((G__1026538 == null))?null:new cljs.core.Keyword(null,"gender","gender",-733930727).cljs$core$IFn$_invoke$arity$1(G__1026538));
if((G__1026538__$1 == null)){
return null;
} else {
return cljs.core.name(G__1026538__$1);
}
})();
...
var G__1026540 = (function (){var or__4253__auto__ = new cljs.core.Keyword(null,"definiteness","definiteness",-1907614985).cljs$core$IFn$_invoke$arity$1(slovarish.frontend.state.result());
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
...
var G__1026541 = slovarish.frontend.state.result();
if((G__1026541 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"verified?","verified?",863527758).cljs$core$IFn$_invoke$arity$1(G__1026541);
}
} else {
...
return alert((function (){var G__1026542 = cljs.core.deref(slovarish.frontend.state.display_language);
var G__1026542__$1 = (((G__1026542 instanceof cljs.core.Keyword))?G__1026542.fqn:null);
switch (G__1026542__$1) {
case "english":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__1026542__$1)].join('')));

}
})());
}
})], null)], null)], null),(((cljs.core.count(cljs.core.deref(slovarish.frontend.state.results)) >= (2)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div#senses","div#senses",-1428700432),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4652__auto__ = (function slovarish$frontend$app$word_input_$_iter__1026543(s__1026544){
return (new cljs.core.LazySeq(null,(function (){
var s__1026544__$1 = s__1026544;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__1026544__$1);
if(temp__5753__auto__){
var s__1026544__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__1026544__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__1026544__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__1026546 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__1026545 = (0);
while(true){
if((i__1026545 < size__4651__auto__)){
var vec__1026547 = cljs.core._nth(c__4650__auto__,i__1026545);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1026547,(0),null);
var gloss = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1026547,(1),null);
cljs.core.chunk_append(b__1026546,((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(slovarish.frontend.state.which_result_QMARK_),(i - (1))))?cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.sense.current","div.sense.current",1137612003),i], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["sense-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i)].join('')], null)):cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.sense","a.sense",1028938672),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"href","href",-793805698),"#",new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__1026545,vec__1026547,i,gloss,c__4650__auto__,size__4651__auto__,b__1026546,s__1026544__$2,temp__5753__auto__){
return (function (e){
var target = e.target.innerHTML;
return cljs.core.reset_BANG_(slovarish.frontend.state.which_result_QMARK_,(target - (1)));
});})(i__1026545,vec__1026547,i,gloss,c__4650__auto__,size__4651__auto__,b__1026546,s__1026544__$2,temp__5753__auto__))
...
var G__1026587 = (i__1026545 + (1));
i__1026545 = G__1026587;
continue;
} else {
return true;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__1026546),slovarish$frontend$app$word_input_$_iter__1026543(cljs.core.chunk_rest(s__1026544__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__1026546),null);
}
} else {
var vec__1026550 = cljs.core.first(s__1026544__$2);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1026550,(0),null);
var gloss = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1026550,(1),null);
return cljs.core.cons(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(slovarish.frontend.state.which_result_QMARK_),(i - (1))))?cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.sense.current","div.sense.current",1137612003),i], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["sense-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i)].join('')], null)):cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.sense","a.sense",1028938672),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"href","href",-793805698),"#",new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__1026550,i,gloss,s__1026544__$2,temp__5753__auto__){
return (function (e){
var target = e.target.innerHTML;
return cljs.core.reset_BANG_(slovarish.frontend.state.which_result_QMARK_,(target - (1)));
});})(vec__1026550,i,gloss,s__1026544__$2,temp__5753__auto__))
], null),i], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["sense-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i)].join('')], null))),slovarish$frontend$app$word_input_$_iter__1026543(cljs.core.rest(s__1026544__$2)));
}
} else {
return null;
}
...
})())], null):null),(cljs.core.truth_(slovarish.frontend.state.result())?(function (){var G__1026553 = cljs.core.deref(slovarish.frontend.state.pos);
var G__1026553__$1 = (((G__1026553 instanceof cljs.core.Keyword))?G__1026553.fqn:null);
switch (G__1026553__$1) {
case "verb":
...
})], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"main","main",-2117802661),new cljs.core.Keyword(null,"defaultValue","defaultValue",-586131910),true], null),(function (){var G__1026554 = cljs.core.deref(slovarish.frontend.state.display_language);
var G__1026554__$1 = (((G__1026554 instanceof cljs.core.Keyword))?G__1026554.fqn:null);
switch (G__1026554__$1) {
case "english":
return "main forms";
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__1026554__$1)].join('')));

}
})()], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"participles","participles",-575696638)], null),(function (){var G__1026555 = cljs.core.deref(slovarish.frontend.state.display_language);
var G__1026555__$1 = (((G__1026555 instanceof cljs.core.Keyword))?G__1026555.fqn:null);
switch (G__1026555__$1) {
case "english":
return "participles";
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__1026555__$1)].join('')));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__1026557__$1)].join('')));
...
})():null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [slovarish.frontend.gloss.render_glosses,slovarish.frontend.state.result(),(function (){var G__1026558 = cljs.core.deref(slovarish.frontend.state.pos);
var G__1026558__$1 = (((G__1026558 instanceof cljs.core.Keyword))?G__1026558.fqn:null);
switch (G__1026558__$1) {
case "noun":
return new cljs.core.Keyword(null,"gender","gender",-733930727).cljs$core$IFn$_invoke$arity$1(slovarish.frontend.state.result());

break;
case "verb":
var G__1026560 = (function (){var or__4253__auto__ = new cljs.core.Keyword(null,"definiteness","definiteness",-1907614985).cljs$core$IFn$_invoke$arity$1(slovarish.frontend.state.result());
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return new cljs.core.Keyword(null,"aspect","aspect",-839905246).cljs$core$IFn$_invoke$arity$1(slovarish.frontend.state.result());
...
var fexpr__1026559 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"indefinite","indefinite",-1961185434),"indefinite",new cljs.core.Keyword(null,"definite","definite",1037141320),"imperfective",new cljs.core.Keyword(null,"pf","pf",1255760069),"perfective",new cljs.core.Keyword(null,"impf","impf",-1164864294),"imperfective",new cljs.core.Keyword(null,"bias","bias",-315297926),"biaspectual"], null);
return (fexpr__1026559.cljs$core$IFn$_invoke$arity$1 ? fexpr__1026559.cljs$core$IFn$_invoke$arity$1(G__1026560) : fexpr__1026559.call(null,G__1026560));
...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p#get-started","p#get-started",-1735449166),(function (){var G__1026563 = cljs.core.deref(slovarish.frontend.state.display_language);
var G__1026563__$1 = (((G__1026563 instanceof cljs.core.Keyword))?G__1026563.fqn:null);
switch (G__1026563__$1) {
case "english":
return "Simply choose a part of speech and type a word in the field above to get started, or ";

break;
case "russian":
return "\u041F\u0440\u043E\u0441\u0442\u043E \u0432\u044B\u0431\u0435\u0440\u0438\u0442\u0435 \u0447\u0430\u0441\u0442\u044C \u0440\u0435\u0447\u0438 \u0438 \u0432\u0432\u0435\u0434\u0438\u0442\u0435 \u0441\u043B\u043E\u0432\u043E \u0432 \u043F\u043E\u043B\u0435 \u043D\u0430\u0432\u0435\u0440\u0445\u0443, \u0447\u0442\u043E\u0431\u044B \u043D\u0430\u0447\u0438\u043D\u0430\u0442\u044C, \u0438\u043B\u0438 ";

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__1026563__$1)].join('')));

}
})(),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.press-enter-instruction","span.press-enter-instruction",26237171),(function (){var G__1026564 = cljs.core.deref(slovarish.frontend.state.display_language);
var G__1026564__$1 = (((G__1026564 instanceof cljs.core.Keyword))?G__1026564.fqn:null);
switch (G__1026564__$1) {
case "english":
return "press Enter ";
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__1026564__$1)].join('')));

}
})()], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.random-word-button-instruction","span.random-word-button-instruction",1588569131),(function (){var G__1026565 = cljs.core.deref(slovarish.frontend.state.display_language);
var G__1026565__$1 = (((G__1026565 instanceof cljs.core.Keyword))?G__1026565.fqn:null);
switch (G__1026565__$1) {
case "english":
return "tap the \uD83C\uDFB2 icon ";
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__1026565__$1)].join('')));

}
})()], null),(function (){var G__1026566 = cljs.core.deref(slovarish.frontend.state.display_language);
var G__1026566__$1 = (((G__1026566 instanceof cljs.core.Keyword))?G__1026566.fqn:null);
switch (G__1026566__$1) {
case "english":
return "to look up a random word.";

break;
case "russian":
return "\u0447\u0442\u043E\u0431\u044B \u043F\u043E\u043A\u0430\u0437\u044B\u0432\u0430\u0442\u044C \u0441\u043B\u0443\u0447\u0430\u0439\u043D\u043E\u0435 \u0441\u043B\u043E\u0432\u043E.";

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__1026566__$1)].join('')));

}
})()], null);
} else {
var source = (function (){var G__1026567 = cljs.core.deref(slovarish.frontend.state.pos);
var G__1026567__$1 = (((G__1026567 instanceof cljs.core.Keyword))?G__1026567.fqn:null);
switch (G__1026567__$1) {
case "noun":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__1026567__$1)].join('')));

}
})();
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div#suggestions.word-buttons","div#suggestions.word-buttons",1062115458),(function (){var temp__5757__auto__ = cljs.core.not_empty(cljs.core.sort_by.cljs$core$IFn$_invoke$arity$3(cljs.core.count,cljs.core._LT_,cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.createAsIfByAssoc([[cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(slovarish.frontend.state.input)),"\u0441\u044F"].join(''),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(slovarish.frontend.state.input)),"\u0441\u044C"].join(''),cljs.core.deref(slovarish.frontend.state.input)]),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__1026561_SHARP_){
return clojure.string.starts_with_QMARK_(p1__1026561_SHARP_,clojure.string.lower_case(cljs.core.deref(slovarish.frontend.state.input)));
}),cljs.core.keys(source)))));
if((temp__5757__auto__ == null)){
return null;
} else {
var predictions = temp__5757__auto__;
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.italic.serif","span.italic.serif",-720224961),(function (){var G__1026568 = cljs.core.deref(slovarish.frontend.state.display_language);
var G__1026568__$1 = (((G__1026568 instanceof cljs.core.Keyword))?G__1026568.fqn:null);
switch (G__1026568__$1) {
case "english":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__1026568__$1)].join('')));

}
})()], null),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4652__auto__ = (function slovarish$frontend$app$suggestions_$_iter__1026569(s__1026570){
return (new cljs.core.LazySeq(null,(function (){
var s__1026570__$1 = s__1026570;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__1026570__$1);
if(temp__5753__auto__){
var s__1026570__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__1026570__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__1026570__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__1026572 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__1026571 = (0);
while(true){
if((i__1026571 < size__4651__auto__)){
var word = cljs.core._nth(c__4650__auto__,i__1026571);
cljs.core.chunk_append(b__1026572,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.word-button","a.word-button",1642105003),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"href","href",-793805698),"#",new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__1026571,word,c__4650__auto__,size__4651__auto__,b__1026572,s__1026570__$2,temp__5753__auto__,predictions,temp__5757__auto__,source){
return (function (p1__1026562_SHARP_){
var word__$1 = p1__1026562_SHARP_.target.innerHTML;
return slovarish.frontend.navigation.go_to_word(word__$1);
});})(i__1026571,word,c__4650__auto__,size__4651__auto__,b__1026572,s__1026570__$2,temp__5753__auto__,predictions,temp__5757__auto__,source))
...
var G__1026600 = (i__1026571 + (1));
i__1026571 = G__1026600;
continue;
} else {
return true;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__1026572),slovarish$frontend$app$suggestions_$_iter__1026569(cljs.core.chunk_rest(s__1026570__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__1026572),null);
}
} else {
var word = cljs.core.first(s__1026570__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.word-button","a.word-button",1642105003),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"href","href",-793805698),"#",new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (word,s__1026570__$2,temp__5753__auto__,predictions,temp__5757__auto__,source){
return (function (p1__1026562_SHARP_){
var word__$1 = p1__1026562_SHARP_.target.innerHTML;
return slovarish.frontend.navigation.go_to_word(word__$1);
});})(word,s__1026570__$2,temp__5753__auto__,predictions,temp__5757__auto__,source))
], null),word], null)," "], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["autosuggest-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(word)].join('')], null)),slovarish$frontend$app$suggestions_$_iter__1026569(cljs.core.rest(s__1026570__$2)));
}
} else {
return null;
}
...
break;
case "adjective":
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__1026579_SHARP_){
return cljs.core.some(new cljs.core.Keyword(null,"adjective?","adjective?",-496987264),cljs.core.val(p1__1026579_SHARP_));
}),cljs.core.deref(slovarish.frontend.data.all_adjectives));

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__1026580__$1)].join('')));

}
})();
var word = cljs.core.rand_nth(cljs.core.keys(source));
console.log(word);

return slovarish.frontend.navigation.go_to_word(word);
});
slovarish.frontend.app.inflector_app = (function slovarish$frontend$app$inflector_app(){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [slovarish.frontend.data.load_mask], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [slovarish.frontend.app.credits], null),new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div#container","div#container",-1257349488),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div#random-word-button","div#random-word-button",-1340613198),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
return slovarish.frontend.app.pick_random_word();
})], null),"\u00A0\uD83C\uDFB2\u00A0"], null)], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [slovarish.frontend.app.header], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [slovarish.frontend.app.word_input], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [slovarish.frontend.app.suggestions], null),(cljs.core.truth_(slovarish.frontend.state.result())?(function (){var G__1026581 = cljs.core.deref(slovarish.frontend.state.pos);
var G__1026581__$1 = (((G__1026581 instanceof cljs.core.Keyword))?G__1026581.fqn:null);
switch (G__1026581__$1) {
case "noun":
...
return slovarish.frontend.navigation.go_to_word(cljs.core.deref(slovarish.frontend.state.input));
});
slovarish.frontend.app.init = (function slovarish$frontend$app$init(){
slovarish.frontend.app.run();

slovarish.frontend.data.load_edn("nouns",(1));

slovarish.frontend.data.load_edn("verbs",(1));

slovarish.frontend.data.load_edn("adjectives",(1));
