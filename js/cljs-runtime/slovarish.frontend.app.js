...
(slovarish.frontend.app.route.cljs$core$IFn$_invoke$arity$variadic = (function (p__26829){
var map__26830 = p__26829;
var map__26830__$1 = cljs.core.__destructure_map(map__26830);
var push_state_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__26830__$1,new cljs.core.Keyword(null,"push-state?","push-state?",-1915122392),true);
var hash = window.location.hash;
var vec__26832 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(cljs.core.subs.cljs$core$IFn$_invoke$arity$2(hash,(2)),/\//);
var target_pos = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26832,(0),null);
var raw = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26832,(1),null);
var sense = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26832,(2),null);
...
cljs.core.reset_BANG_(slovarish.frontend.state.pos,(function (){var fexpr__26838 = new cljs.core.PersistentArrayMap(null, 3, ["n",new cljs.core.Keyword(null,"noun","noun",185846460),"v",new cljs.core.Keyword(null,"verb","verb",-1492655803),"a",new cljs.core.Keyword(null,"adjective","adjective",441465450)], null);
return (fexpr__26838.cljs$core$IFn$_invoke$arity$1 ? fexpr__26838.cljs$core$IFn$_invoke$arity$1(target_pos) : fexpr__26838.call(null,target_pos));
})());
...
return cljs.core.reset_BANG_(slovarish.frontend.state.which_result_QMARK_,(function (){var or__4253__auto__ = (function (){var G__26840 = sense;
if((G__26840 == null)){
return null;
} else {
return (G__26840 - (1));
...
/** @this {Function} */
(slovarish.frontend.app.route.cljs$lang$applyTo = (function (seq26827){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq26827));
}));
...
if((batch > (function (){var G__26845 = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(pos);
return (slovarish.frontend.app.num_batches.cljs$core$IFn$_invoke$arity$1 ? slovarish.frontend.app.num_batches.cljs$core$IFn$_invoke$arity$1(G__26845) : slovarish.frontend.app.num_batches.call(null,G__26845));
})())){
var G__26846 = pos;
switch (G__26846) {
case "nouns":
cljs.core.reset_BANG_(slovarish.frontend.data.top_2k_words,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__26847){
var vec__26848 = p__26847;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26848,(0),null);
var entries = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26848,(1),null);
return cljs.core.some((function (p1__26842_SHARP_){
return (new cljs.core.Keyword(null,"rank","rank",-1706728502).cljs$core$IFn$_invoke$arity$1(p1__26842_SHARP_) <= (2000));
}),entries);
...
return fetch(["edn/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pos),batch_no,".edn"].join('')).then((function (p1__26843_SHARP_){
return p1__26843_SHARP_.text();
})).then((function (p1__26844_SHARP_){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3((function (){var G__26853 = pos;
switch (G__26853) {
case "nouns":
...
})(),cljs.core.merge,cljs.reader.read_string.cljs$core$IFn$_invoke$arity$1(p1__26844_SHARP_));

cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(slovarish.frontend.app.batches_loaded,cljs.core.inc);

var G__26854 = pos;
var G__26855 = (batch + (1));
return (slovarish.frontend.app.load_edn.cljs$core$IFn$_invoke$arity$2 ? slovarish.frontend.app.load_edn.cljs$core$IFn$_invoke$arity$2(G__26854,G__26855) : slovarish.frontend.app.load_edn.call(null,G__26854,G__26855));
}));
}
});
...
if(cljs.core.truth_(and__4251__auto__)){
var G__26858 = cljs.core.deref(slovarish.frontend.state.pos);
var fexpr__26857 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"verb","verb",-1492655803),null,new cljs.core.Keyword(null,"adjective","adjective",441465450),null], null), null);
return (fexpr__26857.cljs$core$IFn$_invoke$arity$1 ? fexpr__26857.cljs$core$IFn$_invoke$arity$1(G__26858) : fexpr__26857.call(null,G__26858));
} else {
return and__4251__auto__;
}
}
...
})], null),(function (){var G__26859 = cljs.core.deref(slovarish.frontend.state.display_language);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26859__$1)].join('')));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26867__$1)].join('')));

}
})(),new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__26870 = cljs.core.deref(slovarish.frontend.state.pos);
var G__26870__$1 = (((G__26870 instanceof cljs.core.Keyword))?G__26870.fqn:null);
switch (G__26870__$1) {
case "noun":
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cljs.core.truth_(new cljs.core.Keyword(null,"verified?","verified?",863527758).cljs$core$IFn$_invoke$arity$1(slovarish.frontend.state.result()))?null:"light"),(function (){var or__4253__auto__ = (function (){var G__26872 = slovarish.frontend.state.result();
var G__26872__$1 = (((G__26872 == null))?null:new cljs.core.Keyword(null,"gender","gender",-733930727).cljs$core$IFn$_invoke$arity$1(G__26872));
if((G__26872__$1 == null)){
return null;
} else {
return cljs.core.name(G__26872__$1);
}
})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
var G__26874 = (function (){var or__4253__auto__ = new cljs.core.Keyword(null,"definiteness","definiteness",-1907614985).cljs$core$IFn$_invoke$arity$1(slovarish.frontend.state.result());
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
...
var G__26875 = slovarish.frontend.state.result();
if((G__26875 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"verified?","verified?",863527758).cljs$core$IFn$_invoke$arity$1(G__26875);
}
} else {
return and__4251__auto__;
}
...
return alert((function (){var G__26876 = cljs.core.deref(slovarish.frontend.state.display_language);
...
});})(i__26879,i,raw_index,c__4650__auto__,size__4651__auto__,b__26880,s__26878__$2,temp__5753__auto__))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26880),slovarish$frontend$app$word_input_$_iter__26877(cljs.core.chunk_rest(s__26878__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26880),null);
}
} else {
var raw_index = cljs.core.first(s__26878__$2);
var i = (raw_index + (1));
return cljs.core.cons(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(slovarish.frontend.state.which_result_QMARK_),raw_index))?cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.sense.current","div.sense.current",1137612003),i], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["sense-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i)].join('')], null)):cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.sense","a.sense",1028938672),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"href","href",-793805698),"#",new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i,raw_index,s__26878__$2,temp__5753__auto__){
return (function (e){
e.preventDefault();
...
return slovarish.frontend.navigation.push_state();
});})(i,raw_index,s__26878__$2,temp__5753__auto__))
], null),i], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["sense-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i)].join('')], null))),slovarish$frontend$app$word_input_$_iter__26877(cljs.core.rest(s__26878__$2)));
}
} else {
return null;
}
...
})())], null):null),(cljs.core.truth_(slovarish.frontend.state.result())?(function (){var G__26881 = cljs.core.deref(slovarish.frontend.state.pos);
...
})], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"main","main",-2117802661),new cljs.core.Keyword(null,"defaultValue","defaultValue",-586131910),true], null),(function (){var G__26882 = cljs.core.deref(slovarish.frontend.state.display_language);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26882__$1)].join('')));

}
})()], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"participles","participles",-575696638)], null),(function (){var G__26883 = cljs.core.deref(slovarish.frontend.state.display_language);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26883__$1)].join('')));
...
})():null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [slovarish.frontend.gloss.render_glosses,slovarish.frontend.state.result(),(function (){var G__26886 = cljs.core.deref(slovarish.frontend.state.pos);
...
break;
case "verb":
var G__26888 = (function (){var or__4253__auto__ = new cljs.core.Keyword(null,"definiteness","definiteness",-1907614985).cljs$core$IFn$_invoke$arity$1(slovarish.frontend.state.result());
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return new cljs.core.Keyword(null,"aspect","aspect",-839905246).cljs$core$IFn$_invoke$arity$1(slovarish.frontend.state.result());
...
var fexpr__26887 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"indefinite","indefinite",-1961185434),"indefinite",new cljs.core.Keyword(null,"definite","definite",1037141320),"imperfective",new cljs.core.Keyword(null,"pf","pf",1255760069),"perfective",new cljs.core.Keyword(null,"impf","impf",-1164864294),"imperfective",new cljs.core.Keyword(null,"bias","bias",-315297926),"biaspectual"], null);
return (fexpr__26887.cljs$core$IFn$_invoke$arity$1 ? fexpr__26887.cljs$core$IFn$_invoke$arity$1(G__26888) : fexpr__26887.call(null,G__26888));
...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p#get-started","p#get-started",-1735449166),(function (){var G__26890 = cljs.core.deref(slovarish.frontend.state.display_language);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26890__$1)].join('')));

}
})(),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.press-enter-instruction","span.press-enter-instruction",26237171),(function (){var G__26891 = cljs.core.deref(slovarish.frontend.state.display_language);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26891__$1)].join('')));

}
})()], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.random-word-button-instruction","span.random-word-button-instruction",1588569131),(function (){var G__26892 = cljs.core.deref(slovarish.frontend.state.display_language);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26892__$1)].join('')));

}
})()], null),(function (){var G__26893 = cljs.core.deref(slovarish.frontend.state.display_language);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26893__$1)].join('')));

}
})()], null);
} else {
var source = (function (){var G__26894 = cljs.core.deref(slovarish.frontend.state.pos);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26894__$1)].join('')));

}
})();
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div#suggestions.word-buttons","div#suggestions.word-buttons",1062115458),(function (){var temp__5757__auto__ = cljs.core.not_empty(cljs.core.sort_by.cljs$core$IFn$_invoke$arity$3(cljs.core.count,cljs.core._LT_,cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.createAsIfByAssoc([[cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(slovarish.frontend.state.input)),"\u0441\u044F"].join(''),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(slovarish.frontend.state.input)),"\u0441\u044C"].join(''),cljs.core.deref(slovarish.frontend.state.input)]),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__26889_SHARP_){
return clojure.string.starts_with_QMARK_(p1__26889_SHARP_,clojure.string.lower_case(cljs.core.deref(slovarish.frontend.state.input)));
}),cljs.core.keys(source)))));
if((temp__5757__auto__ == null)){
return null;
} else {
var predictions = temp__5757__auto__;
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.italic.serif","span.italic.serif",-720224961),(function (){var G__26895 = cljs.core.deref(slovarish.frontend.state.display_language);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26895__$1)].join('')));

}
})()], null),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4652__auto__ = (function slovarish$frontend$app$suggestions_$_iter__26896(s__26897){
return (new cljs.core.LazySeq(null,(function (){
var s__26897__$1 = s__26897;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__26897__$1);
if(temp__5753__auto__){
var s__26897__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__26897__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__26897__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__26899 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__26898 = (0);
while(true){
if((i__26898 < size__4651__auto__)){
var word = cljs.core._nth(c__4650__auto__,i__26898);
cljs.core.chunk_append(b__26899,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.word-button","a.word-button",1642105003),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"href","href",-793805698),"#",new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__26898,word,c__4650__auto__,size__4651__auto__,b__26899,s__26897__$2,temp__5753__auto__,predictions,temp__5757__auto__,source){
return (function (e){
e.preventDefault();

var word__$1 = e.target.innerHTML;
return slovarish.frontend.navigation.go_to_word(word__$1);
});})(i__26898,word,c__4650__auto__,size__4651__auto__,b__26899,s__26897__$2,temp__5753__auto__,predictions,temp__5757__auto__,source))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26899),slovarish$frontend$app$suggestions_$_iter__26896(cljs.core.chunk_rest(s__26897__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26899),null);
}
} else {
var word = cljs.core.first(s__26897__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.word-button","a.word-button",1642105003),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"href","href",-793805698),"#",new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (word,s__26897__$2,temp__5753__auto__,predictions,temp__5757__auto__,source){
return (function (e){
e.preventDefault();

var word__$1 = e.target.innerHTML;
return slovarish.frontend.navigation.go_to_word(word__$1);
});})(word,s__26897__$2,temp__5753__auto__,predictions,temp__5757__auto__,source))
], null),word], null)," "], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["autosuggest-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(word)].join('')], null)),slovarish$frontend$app$suggestions_$_iter__26896(cljs.core.rest(s__26897__$2)));
}
} else {
return null;
}
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div#legend","div#legend",-1923867619),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h1","h1",-1896887462),(function (){var G__26900 = cljs.core.deref(slovarish.frontend.state.display_language);
...
break;
case "russian":
return ["\u0437\u043D\u0430\u0447\u0435\u043D\u0438\u0435 \u0437\u043D\u0430\u043A\u043E\u0432 (\u0434\u043B\u044F ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__26904 = cljs.core.deref(slovarish.frontend.state.pos);
var fexpr__26903 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"noun","noun",185846460),"\u0441\u0443\u0449\u0435\u0441\u0442\u0432\u0438\u0442\u0435\u043B\u044C\u043D\u044B\u0445",new cljs.core.Keyword(null,"verb","verb",-1492655803),"\u0433\u043B\u0430\u0433\u043E\u043B\u043E\u0432",new cljs.core.Keyword(null,"adjective","adjective",441465450),"\u043F\u0440\u0438\u043B\u0430\u0433\u0430\u0442\u0435\u043B\u044C\u043D\u044B\u0445"], null);
return (fexpr__26903.cljs$core$IFn$_invoke$arity$1 ? fexpr__26903.cljs$core$IFn$_invoke$arity$1(G__26904) : fexpr__26903.call(null,G__26904));
})()),")"].join('');

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26900__$1)].join('')));

}
})()], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(slovarish.frontend.state.display_language),new cljs.core.Keyword(null,"russian","russian",1887936458)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p.italic","p.italic",60958886),"(\u041A \u0441\u043E\u0436\u0430\u043B\u0435\u043D\u0438\u044E, \u043F\u043E\u043B\u043D\u043E\u0433\u043E \u043F\u0435\u0440\u0435\u0432\u043E\u0434\u0430 \u044D\u0442\u043E\u0433\u043E \u0442\u0435\u043A\u0441\u0442\u0430 \u043D\u0430 \u0440\u0443\u0441\u0441\u043A\u0438\u0439 \u043F\u043E\u043A\u0430 \u043D\u0435\u0442.)"], null):null),(function (){var G__26905 = cljs.core.deref(slovarish.frontend.state.pos);
...
var source = (function (){var G__26907 = cljs.core.deref(slovarish.frontend.state.pos);
...
return cljs.core.some(new cljs.core.Keyword(null,"adjective?","adjective?",-496987264),cljs.core.val(p1__26906_SHARP_));
...
})], null),"\u00A0\uD83C\uDFB2\u00A0"], null)], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [slovarish.frontend.app.header], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [slovarish.frontend.app.word_input], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [slovarish.frontend.app.suggestions], null),(cljs.core.truth_(slovarish.frontend.state.result())?(function (){var G__26908 = cljs.core.deref(slovarish.frontend.state.pos);
