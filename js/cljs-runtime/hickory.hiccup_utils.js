...
var and__4251__auto__ = ((0) < ((tag_elem__$1).length));
if(and__4251__auto__){
var and__4251__auto____$1 = (((tag_cutoff === (-1)))?true:(tag_cutoff > (0)));
if(and__4251__auto____$1){
var and__4251__auto____$2 = (((hash_idx === (-1)))?true:((((-1) === hickory.hiccup_utils.index_of.cljs$core$IFn$_invoke$arity$3(tag_elem__$1,"#",(hash_idx + (1))))) && (((hash_idx + (1)) < hickory.hiccup_utils.first_idx(hickory.hiccup_utils.index_of.cljs$core$IFn$_invoke$arity$3(tag_elem__$1,".",(hash_idx + (1))),((tag_elem__$1).length))))));
if(and__4251__auto____$2){
var and__4251__auto____$3 = ((((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(hash_idx,(-1))) && (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(dot_idx,(-1)))))?(hash_idx < dot_idx):true);
if(and__4251__auto____$3){
if((dot_idx === (-1))){
return true;
} else {
var classes = tag_elem__$1.substring((dot_idx + (1)));
return cljs.core.every_QMARK_((function (p1__44202_SHARP_){
return ((0) < cljs.core.count(p1__44202_SHARP_));
...
if((cutoff === (-1))){
var G__44214 = next_dot;
var G__44215 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(classes,tag_elem__$1.substring((curr_dot + (1))));
curr_dot = G__44214;
classes = G__44215;
continue;
} else {
var G__44216 = next_dot;
var G__44217 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(classes,tag_elem__$1.substring((curr_dot + (1)),cutoff));
curr_dot = G__44216;
classes = G__44217;
continue;
}
...
var G__44218 = cljs.core.next(remaining_content);
var G__44219 = (function (){var remaining_seq = cljs.core.first(remaining_content);
var result__$1 = result;
while(true){
if((remaining_seq == null)){
return result__$1;
} else {
var G__44220 = cljs.core.next(remaining_seq);
var G__44221 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(result__$1,cljs.core.first(remaining_seq));
remaining_seq = G__44220;
result__$1 = G__44221;
continue;
}
break;
...
remaining_content = G__44218;
result = G__44219;
continue;
} else {
var G__44222 = cljs.core.next(remaining_content);
var G__44223 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(result,cljs.core.first(remaining_content));
remaining_content = G__44222;
result = G__44223;
continue;
}
}
...
var tag_elem = first__44205;
var content = seq__44204__$1;
...
var vec__44206 = ((cljs.core.map_QMARK_(cljs.core.first(content)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(content),cljs.core.rest(content)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,content], null));
var map_attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44206,(0),null);
var content__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44206,(1),null);
...
var vec__44210 = hickory.hiccup_utils.normalize_element(form);
...
var tag = first__44212;
var first__44212__$1 = cljs.core.first(seq__44211__$1);
var seq__44211__$2 = cljs.core.next(seq__44211__$1);
var attrs = first__44212__$1;
var contents = seq__44211__$2;
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(cljs.core.vector,tag,attrs,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__44209_SHARP_){
if(cljs.core.vector_QMARK_(p1__44209_SHARP_)){
return (hickory.hiccup_utils.normalize_form.cljs$core$IFn$_invoke$arity$1 ? hickory.hiccup_utils.normalize_form.cljs$core$IFn$_invoke$arity$1(p1__44209_SHARP_) : hickory.hiccup_utils.normalize_form.call(null,p1__44209_SHARP_));
} else {
return p1__44209_SHARP_;
}
