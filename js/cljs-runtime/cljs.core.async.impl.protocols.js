...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26500 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26500(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26507 = (function (port,val,fn1_handler){
var x__4550__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26507(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26515 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26515(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26523 = (function (chan){
var x__4550__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26523(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26532 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26532(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26533 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26533(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_26534 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_26534(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26537 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26537(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26538 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26538(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26539 = (function (b,itm){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26539(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26541 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26541(b);
}
});
