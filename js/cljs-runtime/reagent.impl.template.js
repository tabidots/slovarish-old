...
var G__36656 = o;
reagent.impl.template.goog$module$goog$object.set(G__36656,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__36740__delegate = function (args){
...
while (G__36741__i < G__36741__a.length) {G__36741__a[G__36741__i] = arguments[G__36741__i + 0]; ++G__36741__i;}
  args = new cljs.core.IndexedSeq(G__36741__a,0,null);
} 
return G__36740__delegate.call(this,args);};
G__36740.cljs$lang$maxFixedArity = 0;
G__36740.cljs$lang$applyTo = (function (arglist__36742){
var args = cljs.core.seq(arglist__36742);
return G__36740__delegate(args);
});
...
var G__36662 = o;
reagent.impl.template.goog$module$goog$object.set(G__36662,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__36745__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__36746__i < G__36746__a.length) {G__36746__a[G__36746__i] = arguments[G__36746__i + 0]; ++G__36746__i;}
  args = new cljs.core.IndexedSeq(G__36746__a,0,null);
} 
return G__36745__delegate.call(this,args);};
G__36745.cljs$lang$maxFixedArity = 0;
G__36745.cljs$lang$applyTo = (function (arglist__36747){
var args = cljs.core.seq(arglist__36747);
return G__36745__delegate(args);
});
...
var G__36666 = props;
var G__36666__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36666,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__36666);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36666__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__36667 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36667,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__36667;
}
})(),id_class);
...
var G__36668 = (cljs.core.count(argv) - first_child);
switch (G__36668) {
case (0):
...
var vec__36669 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36669,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36669,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36669,(2),null);
...
var temp__5757__auto___36771 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___36771 == null)){
} else {
var key_36772 = temp__5757__auto___36771;
(jsprops.key = key_36772);
}
...
var temp__5757__auto___36777 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___36777 == null)){
} else {
var key_36778 = temp__5757__auto___36777;
(jsprops.key = key_36778);
}
...
var temp__5757__auto___36781 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___36781 == null)){
} else {
var key_36782 = temp__5757__auto___36781;
(jsprops.key = key_36782);
}
...
var temp__5757__auto___36789 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___36789 == null)){
} else {
var key_36790 = temp__5757__auto___36789;
(jsprops.key = key_36790);
}
...
var temp__5757__auto___36792 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___36792 == null)){
} else {
var key_36793 = temp__5757__auto___36792;
(jsprops.key = key_36793);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__36680_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__36680_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__36682 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36682,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36682,(1),null);
...
break;
default:
var G__36810 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__36811 = compiler;
v = G__36810;
compiler = G__36811;
continue;
...
var G__36692 = tag;
var G__36692__$1 = (((G__36692 instanceof cljs.core.Keyword))?G__36692.fqn:null);
switch (G__36692__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template36706 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template36706 = (function (opts,id,fn_to_element,parse_fn,meta36707){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template36706.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_36708,meta36707__$1){
var self__ = this;
var _36708__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template36706(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta36707__$1));
}));

(reagent.impl.template.t_reagent$impl$template36706.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_36708){
var self__ = this;
var _36708__$1 = this;
return self__.meta36707;
}));

(reagent.impl.template.t_reagent$impl$template36706.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template36706.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template36706.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template36706.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template36706.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template36706.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta36707","meta36707",1810004052,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template36706.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template36706.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template36706");

(reagent.impl.template.t_reagent$impl$template36706.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template36706");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template36706.
 */
reagent.impl.template.__GT_t_reagent$impl$template36706 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template36706(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta36707){
return (new reagent.impl.template.t_reagent$impl$template36706(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta36707));
});

}

return (new reagent.impl.template.t_reagent$impl$template36706(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
